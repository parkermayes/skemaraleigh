...
const ONE_OFFS = [
  ...
  {
    date: '2026-09-11',
    start: '2026-09-11T12:00:00-04:00',
    end:   '2026-09-11T12:30:00-04:00',
    time: 'Noon',
    name: 'Accelerator Cohort Announced',
    track: 'accelerator',
    inBanner: false,
    desc: 'The Fall 2026 cohort is selected and announced: twelve ventures for twelve weeks, with the first weekly working session on September 15 and Demo Day on November 19.',
    where: 'Online',
    address: 'Announced online to everyone who applied',
    cta: { label: 'Apply Now', href: LINKS.accelerator },
  },
  {
    date: '2026-09-23',
